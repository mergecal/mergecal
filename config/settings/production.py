...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["Mergecal.org"])
...
STORAGES = {
    "default": {
        "BACKEND": "mergecal.utils.storages.MediaRootS3Boto3Storage",
    },
    "staticfiles": {
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="MergeCal <noreply@mergecal.org>",
)
